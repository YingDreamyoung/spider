package us.codecraft.jobhunter.common;
...
import us.codecraft.jobhunter.util.PropertiesUtil;
...
public class RedisPool {
    ...
    private static Integer maxIdle = Integer.parseInt(PropertiesUtil.getProperty("redis.max.idle","100"));//在jedispool中最大的idle状态(空闲的)的jedis实例的个数
    ...
    private static void initPool(){
        ...
        pool = new JedisPool(config,redisIp,redisPort,1000*9);
    }
    ...
    public static void main(String[] args) {
       ...
       String redisUrl="";
       String redisUrl2="23";
       String redisUrl3=null;
        System.out.println(StringUtils.isNotBlank(redisUrl));
        System.out.println(StringUtils.isNotBlank(redisUrl2));
        System.out.println(StringUtils.isNotBlank(redisUrl3));
